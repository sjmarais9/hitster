...
import { CLIENT_ID, SCOPES, AUTHORIZE_ENDPOINT, TOKEN_ENDPOINT, redirectUri, basePath } from './config.js?v=7a53434d';
import { createVerifier, createState, challengeFor } from './pkce.js?v=7a53434d';
