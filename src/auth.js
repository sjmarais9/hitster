...
import { CLIENT_ID, SCOPES, AUTHORIZE_ENDPOINT, TOKEN_ENDPOINT, redirectUri, basePath } from './config.js?v=da0baee5';
import { createVerifier, createState, challengeFor } from './pkce.js?v=da0baee5';
