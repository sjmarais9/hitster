...
import { CLIENT_ID, SCOPES, AUTHORIZE_ENDPOINT, TOKEN_ENDPOINT, redirectUri, basePath } from './config.js?v=af25f86d';
import { createVerifier, createState, challengeFor } from './pkce.js?v=af25f86d';
